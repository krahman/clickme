...
["", "clickme.dart", , G, {
  ...
  main: [function() {
    var obj, t1;
    obj = document.querySelector("#sample_text_id");
    obj.textContent = "Click me!";
    obj.toString;
    t1 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(obj, C.EventStreamProvider_click._eventType, false), [null]);
    ...
    t1 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(obj, C.EventStreamProvider_mouseover._eventType, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(G.magnifyText$closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(obj, C.EventStreamProvider_mouseleave._eventType, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(G.resetFonsize$closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
  }, "call$0", "main$closure", 0, 0, 0],
  reverseText: [function($event) {
    var trgt, t1, t2;
    trgt = J.get$target$x($event);
    t1 = J.getInterceptor$x(trgt);
    trgt.textContent = G.doReverseText(t1.get$text(trgt));
    t1 = J.get$color$x(t1.get$style(trgt));
    t2 = trgt.style;
    if (t1 === "green")
      J.set$color$x(t2, "black");
    else
      J.set$color$x(t2, "green");
  }, "call$1", "reverseText$closure", 2, 0, 1],
  doReverseText: function(text) {
    var buffer, i, t1;
    buffer = P.StringBuffer$("");
  ...
  magnifyText: [function($event) {
    var trgt = J.get$target$x($event);
    J.set$color$x(J.get$style$x(trgt), "red");
    J.set$cursor$x(trgt.style, "pointer");
  }, "call$1", "magnifyText$closure", 2, 0, 1],
  resetFonsize: [function($event) {
    var trgt = J.get$target$x($event);
    J.set$color$x(J.get$style$x(trgt), "black");
    J.set$cursor$x(trgt.style, "none");
  }, "call$1", "resetFonsize$closure", 2, 0, 1]
},
1],
